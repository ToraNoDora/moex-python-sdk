...
from moex_python_sdk.models.boards import BaseBoards
...
class HistoryApi:
    ...
    def get_board_by_dates(self, engine: str, market: str, board: str, params: HistoryDatesParams, format: str = "json"):
        ...
        return r["url"], HistoryDates(dates=new_resp_data(r["data"]["dates"]))
    ...
    def get_board_security(self, engine: str, market: str, board: str, security: str, params: HistorySecurityParams, format: str = "json"):
        ...
        return r["url"], HistoryBase(history=new_resp_data(r["data"]["history"]))
    ...
    def get_board_yields(self, engine: str, market: str, board: str, params: HistoryYieldsParams, format: str = "json"):
        ...
        return r["url"], HistoryYields(history_yield=new_resp_data(r["data"]["history.yields"]))
    ...
    def get_boardgroup_securities_with_action(self, engine: str, market: str, boardgroup: str, params: HistoryBoardgroupsSecuritiesParams, format: str = "json"):
        ...
        return r["url"], HistoryBoardgroupsSecurities(
            ...
            auctions_dates=new_resp_data(r["data"]["auctions.dates"]),
        )
    ...
    def get_boardgroup_yields(self, engine: str, market: str, boardgroup: str, params: HistoryYieldsParams, format: str = "json"):
        ...
        return r["url"], HistoryYields(history_yields=new_resp_data(r["data"]["history_yields"]))
    ...
    def get_market_by_dates(self, engine: str, market: str, params: HistoryDatesParams, format: str = "json"):
    ...
    def get_market_listing(self, engine: str, market: str, params: HistoryListingParams, format: str = "json"):
    ...
    def get_market_security(self, engine: str, market: str, security: str, params: HistorySecurityParams, format: str = "json"):
    ...
    def get_market_sessions(self, engine: str, market: str, params: LangParams, format: str = "json"):
        ...
        return r["url"], HistorySession(trading_sessions=new_resp_data(r["data"]["trading_sessions"]))
    ...
    def get_securities_changeover(self, format: str = "json"):
        ...
        return r["url"], HistoryChangeover(changeover=new_resp_data(r["data"]["changeover"]))
    ...
    def get_stock_totals_boards(self, format: str = "json"):
        ...
        return r["url"], BaseBoards(boards=new_resp_data(r["data"]["boards"]))
    ...
    def get_stock_zcyc(self, params: HistoryZcycParams, format: str = "json"):
        ...
        return r["url"], HistoryZcyc(params=new_resp_data(r["data"]["params"]))

    def get_markets_info(self, params: LangParams, format: str = "ru"):
        """Обобщенные данные ОТС ПФИ и РЕПО - список рынков (доступно только подписчикам)."""
    ...
    def get_daily_market_info(self, market: str, params: DateParams, format: str = "ru"):
        """Ежедневные обобщенные данные ОТС ПФИ и РЕПО (доступно только подписчикам)."""
    ...
    def get_monthly_market_info(self, market: str, params: MonthParams, format: str = "ru"):
        """Ежемесячные обобщенные данные ОТС ПФИ и РЕПО (доступно только подписчикам)."""
